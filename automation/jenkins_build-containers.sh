...
do
  ...
  case ${DOCKERFILE} in
    ...
    *)
      ...
      DOCKERFILE_PATH="-f ${script_dir}/${DOCKERFILE}"
      BUILDER_OPTS="--build-arg NAMESPACE=${NAMESPACE}"
      ;;
  esac
  # Build
  "${BUILDER}" build --pull ${NOCACHE} ${BUILDER_OPTS} ${TAG} ${DOCKERFILE_PATH} "${script_dir}"
