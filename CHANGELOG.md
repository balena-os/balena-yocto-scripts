...
* balena-build: Shorten installation directory [Alex Gonzalez]
* prepare-and-start: Shorten installation directory [Alex Gonzalez]
* Dockerfile: yocto-build-env: Shorten installation path [Alex Gonzalez]
* Dockerfile: balena-push-env: Shorten installation directory [Alex Gonzalez]
