...
* jenkins_build.sh: refactor the code for balena.img handling [Michal Toman]
* jenkins_build.sh: publish explicitly named balena-raw and balena-flasher images [Michal Toman]
* jenkins_build.sh: rename resin-flasher.img to balena-flasher.img [Michal Toman]
