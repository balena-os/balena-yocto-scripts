...
* automation: Add script to finalize a release [Alex Gonzalez]
* balena-lib: Extract checking for ESR version [Alex Gonzalez]
* balena-api: Add function to fetch releaseID from version [Alex Gonzalez]
