...
* docs: Add documentation to explain the automated build of extensions [Alex Gonzalez]
* Add support for building and pre-loading package-bsed host extensions [Alex Gonzalez]
* Dockerfile_package-based-hostext: Add  container to build hostapp extensions [Alex Gonzalez]
* jenkins-hostapp-extension: Add script to build host extension [Alex Gonzalez]
* jenkins-package-feed: Add a builder script for package feeds [Alex Gonzalez]
* Add host extension support to balena-push-env helper container image [Alex Gonzalez]
* Update Ubuntu version on balena-push-env helper container image [Alex Gonzalez]
* balena-api: Script library with API calls [Alex Gonzalez]
* balena-hostapp-extension: Build hostapp extension in container [Alex Gonzalez]
...
* Helper container images can now be device specific [Alex Gonzalez]
...
* prepare-and-start: If hostapp extensions are to be built login to the registry [Alex Gonzalez]
...
* Add host extension build support to Barys [Alex Gonzalez]
